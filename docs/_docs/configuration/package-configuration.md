...
```php
\Twigger\Translate\SettingsServiceProvider::withoutBodyDetector();
```
...
```php
\Twigger\Translate\SettingsServiceProvider::withoutCookieDetector();
```
...
```php
\Twigger\Translate\SettingsServiceProvider::withoutHeaderDetector();
```
...
```php
\Twigger\Translate\SettingsServiceProvider::withoutCache(); // Don't use the cache
\Twigger\Translate\SettingsServiceProvider::withoutDatabaseOverrides(); // Don't look for translations in the database
\Twigger\Translate\SettingsServiceProvider::withoutLangFiles(); // Don't load any language files
```
